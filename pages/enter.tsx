...
// 유저가 폰번호를 백엔드로 전송 -> withHandler 함수와 프론트의 mutation 함수를 이용
// 백엔드에서 유저의 폰번호 검색 존재하지 않으면 회원가입, 존재하면 데이터베이스에서 정보 가져옴
// 유저를 위한 토큰 발행 -> 문자로 랜덤 숫자를 유저에게 보냄
// 토큰을 입력 -> 백엔드 전송 -> 토큰정보 찾으면 로그인 시키기
    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid pb-4 w-full mt-8 grid-cols-2 ">
            {/* <button
              className={`pb-4  ${
                method === "email"
